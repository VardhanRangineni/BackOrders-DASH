...
export const webOrders = [
  {
    ...
    status: 'Partially Fulfilled', // Web Order Level Status: Approved, Partially Fulfilled, Fulfilled
    items: [
      {
        lineId: 'WOL-001-1',
        ...
        qtyFulfilled: 300,
        qtyPending: 200,
        // Product Level Status: Pending, Partially Fulfilled Internally, Fully Fulfilled Internally, 
        // Draft Created, TO Created / PO Created, Partially Fulfilled, Completely Fulfilled, 
        // NA internally, Market Purchase Initiated, NA in Market
        status: 'Partially Fulfilled',
        sourceType: 'Store', // Store Id / Distributor Id
